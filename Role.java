...
public class Role<role> {
    public static void main(String[] args) {
        ...
        Role r1 = new Role("英雄", 100,'男');
        Role r2 = new Role("怪兽", 100, '女');
    ...
    private char gender;
    private String face;
    String[] boyfaces = {"风流倜傥", "气宇轩昂", "相貌平平", "一塌糊涂"};
    String[] girlfaces = {"沉鱼落雁", "闭月羞花", "相貌平平", "一塌糊涂"};

    String[] attack_desc={
            "%s使出了一招【背心钉】，转到对方的身后，一掌向%s背后的灵台穴拍去。",
